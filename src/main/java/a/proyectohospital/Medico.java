package a.proyectohospital;

import Data.CrearDatos;
...
public class Medico extends Persona {
    ...
    public double calcularBonificacion(Medico objMedico) {
        ...
        if ("General".equals(objMedico.getEspecialidad())) {
            objMedico.datEmpleado
                    .setSalario((int) (objMedico.datEmpleado.getSalario() + objMedico.datEmpleado.getSalario() * 0.05));
            ...
            objMedico.datEmpleado
                    .setSalario((int) (objMedico.datEmpleado.getSalario() + objMedico.datEmpleado.getSalario() * 0.02));
        }
